...
describe('inverse', () => {
   ...
   *    [ ]
   */
  it('should take inverse of 0, 0, 16, 0, 0, 0 when base is passed in', () => {
    expect(inverse(0, 0, 16, 0, 0, 0, { ...robotConfig, base: 1 })).toEqual([0, 0, 0, 0, 0, 0]);
  });
   ...
   *    [ ]
   */
  it('should take inverse of 5, 0, 10, 0, 0, 0 when base is passed', () => {
    expect(inverse(5, 0, 11, 0, 0, 0, { ...robotConfig, base: 1 })).toEqual([
      0,
      0,
      -Math.PI / 2,
      Math.PI,
